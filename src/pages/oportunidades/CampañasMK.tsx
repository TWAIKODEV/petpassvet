...
import { Plus, Search, Filter, Download, Calendar, RefreshCw, Eye, Edit, Trash, BarChart2, ArrowRight, ArrowDown, Mail, MessageSquare, Phone, Target, Users, DollarSign, Megaphone, Globe, Instagram, Facebook, Linkedin, Twitter, Youtube, TrendingUp, X } from 'lucide-react';
...
interface Campaign {
  id: string;
  name: string;
  type: 'email' | 'social' | 'web' | 'event' | 'referral';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Funnel MK</h1>
